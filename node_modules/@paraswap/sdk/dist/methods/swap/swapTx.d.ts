...
import type { ConstructFetchInput, RequestParameters, SwapApiResponse } from '../../types';
/**
...
type SwapTxInputFields = 'srcToken' | 'destToken' | 'amount' | 'side' | 'srcDecimals' | 'destDecimals' | 'userAddress' | 'slippage';
type SwapTxInputListFields = 'includeDEXS' | 'excludeDEXS' | 'includeContractMethods' | 'excludeContractMethods' | 'route';
type SwapRateOptions = Omit<SwapQueryParams, SwapTxInputFields | SwapTxInputListFields | 'network' | 'version'> & {
    /**
...
export type GetSwapTxData = (options: SwapTxInput, requestParams?: RequestParameters) => Promise<SwapTxResult>;
export type GetSwapTxFunctions = {
    getSwapTxData: GetSwapTxData;
};
export declare const constructSwapTx: ({ apiURL, version, chainId, fetcher, }: ConstructFetchInput) => GetSwapTxFunctions;
export {};
//# sourceMappingURL=swapTx.d.ts.map