      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            assert(isEthersProviderWithSigner$1(providerOrSigner) || isEthersSigner$1(providerOrSigner), 'ethers must be an instance of Signer or JsonRpcProvider to create a signer');
            address = params.address, abi = params.abi, contractMethod = params.contractMethod, args = params.args, overrides = params.overrides;
...
function assertEthersContractHasMethodsV5(contract) {
  ...
  assert(ethersContractHasMethodsV5.apply(void 0, [contract].concat(methods)), "Contract must have methods: " + methods.join(', '));
}
  ...
  var staticCall = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(params) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            assert(viemClient.readContract, 'Viem client must have readContract Public Action');
            address = params.address, abi = params.abi, contractMethod = params.contractMethod, args = params.args, overrides = params.overrides;
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            assert(viemClient.writeContract, 'Viem client must have writeContract Wallet Action');
            address = params.address, abi = params.abi, contractMethod = params.contractMethod, args = params.args, overrides = params.overrides;
    ...
    var _ref4 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(typedData) {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            assert(account, 'account must be specified to create a signer');
            assert(viemClient.signTypedData, 'Viem client must have signTypedData Wallet Action');
            data = typedData.data, domain = typedData.domain, types = typedData.types;
            primaryType = findPrimaryType(types);
