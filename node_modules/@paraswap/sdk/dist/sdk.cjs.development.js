...
var _excluded$9 = ["tokenType", "mainConnector", "connectors", "network"];
var constructToken = function constructToken(tokenProps) {
  var _tokenProps$tokenType = tokenProps.tokenType,
    ...
    rest = _objectWithoutPropertiesLoose(tokenProps, _excluded$9);
...
var _excluded$8 = ["options"],
  _excluded2$4 = ["excludePricingMethods", "excludeContractMethods", "includeContractMethods", "partner", "includeDEXS", "excludeDEXS", "excludePools"];
function normalizeRateOptions(_ref) {
  var _ref$options = _ref.options,
    options = _ref$options === void 0 ? {} : _ref$options,
    restInput = _objectWithoutPropertiesLoose(_ref, _excluded$8);
  ...
  var _map = [includeDEXS, excludeDEXS, excludePools, excludePricingMethods, excludeContractMethods, includeContractMethods
    //                                                                                              no "" empty string
    ].map(function (array) {
...
var _excluded$7 = ["srcToken", "destToken"],
  _excluded2$3 = ["route"];
  ...
  var getRate = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(_ref2, requestParams) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            srcToken = _ref2.srcToken, destToken = _ref2.destToken, rest = _objectWithoutPropertiesLoose(_ref2, _excluded$7);
...
var _excluded$6 = ["srcToken", "destToken", "amount", "route"];
  ...
  var getSwapTxData = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(_ref2, requestParams) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            srcToken = _ref2.srcToken, destToken = _ref2.destToken, amount = _ref2.amount, route = _ref2.route, rest = _objectWithoutPropertiesLoose(_ref2, _excluded$6);
            parsedOptions = normalizeRateOptions(rest);
...
var _excluded$4 = ["srcToken", "destToken", "amount", "options"];
  ...
  var getNFTOrdersRate = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(_ref2, orders, requestParams) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            srcToken = _ref2.srcToken, destToken = _ref2.destToken, amount = _ref2.amount, _ref2$options = _ref2.options, _options = _ref2$options === void 0 ? {} : _ref2$options, rest = _objectWithoutPropertiesLoose(_ref2, _excluded$4);
            tsEssentials.assert(orders.length > 0, 'must pass at least 1 order');
    ...
    var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(params) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            requestParams = params.requestParams, rest = _objectWithoutPropertiesLoose(params, _excluded$3); // adding apiKey to headers if it's provided
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            gas = overrides.gas, value = overrides.value, restOverrides = _objectWithoutPropertiesLoose(overrides, _excluded);
            normalizedOverrides = _extends({}, restOverrides, {
...
function composeDeltaOrderPermit(_ref) {
  var permit = _ref.permit,
    nonce = _ref.nonce;
...
function encodePermit2Transfer(nonce, signature) {
  ...
  return '0x' + Array.from(packedBuffer).map(function (b) {
    return b.toString(16).padStart(2, '0');
  }).join('');
}
...
function buildDeltaSignableOrderData(_ref2) {
  var owner = _ref2.owner,
    ...
    expectedDestAmount = _ref2.expectedDestAmount,
  ...
  var orderInput = {
    ...
    deadline: deadline,
    nonce: nonce,
    permit: composeDeltaOrderPermit({
      permit: permit,
      nonce: nonce
    }),
...
var constructBuildDeltaOrder = function constructBuildDeltaOrder(options) {
  ...
  var buildDeltaOrder = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(options, requestParams) {
      ...
      var ParaswapDelta, partnerAddress, partnerFeeBps, partnerTakesSurplus, feeOrTakeSurplusSupplied, _partnerAddress, _partnerFeeBps, _partnerTakesSurplus, partner, partnerFeeResponse, bridge, input;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
          ...
          case 17:
            bridge = options.bridge ? _extends({}, options.bridge, {
              multiCallHandler:
...
function sanitizeDeltaOrderData(_ref) {
  var owner = _ref.owner,
    ...
    expectedDestAmount = _ref.expectedDestAmount,
    deadline = _ref.deadline,
    nonce = _ref.nonce,
    permit = _ref.permit,
        ...
        while (1) switch (_context.prev = _context.next) {
          case 0:
            search = constructSearchString(_extends({}, options, {
              chainId: chainId,
              side: core.SwapSide.SELL // so far SELL side only
            }));
            fetchURL = pricesUrl + "/" + search;
            _context.next = 4;
            return fetcher({
...
var constructApproveTokenForDelta = function constructApproveTokenForDelta(options) {
  ...
  var _constructGetDeltaCon = constructGetDeltaContract(options),
    getDeltaContract = _constructGetDeltaCon.getDeltaContract;
  var getParaswapDelta = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(requestParams) {
      var deltaContract;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
    ...
    return function getParaswapDelta(_x) {
      return _ref.apply(this, arguments);
    };
  }();
  var approveTokenForDelta = approveTokenMethodFactory(options.contractCaller, getParaswapDelta);
  return {
...
var constructAllDeltaOrdersHandlers = function constructAllDeltaOrdersHandlers(options) {
  ...
  return _extends({}, deltaOrdersGetters, deltaOrdersContractGetter, deltaPrice, partnerFee, bridgeInfo, isTokenSupportedInDelta, multicallHandlers, approveTokenForDelta, deltaOrdersSubmit, deltaOrdersBuild, deltaOrdersSign, deltaOrdersPost);
};
...
function constructSimpleSDK(options, providerOptions) {
  ...
  if (!providerOptions) {
    ...
    var _delta = constructPartialSDK(_config, constructBuildDeltaOrder, constructPostDeltaOrder, constructGetDeltaOrders, constructGetDeltaPrice, constructGetDeltaContract, constructGetPartnerFee, constructGetMulticallHandlers, constructGetBridgeInfo, constructIsTokenSupportedInDelta);
...
var ParaSwap = /*#__PURE__*/function () {
  function ParaSwap(_ref) {
    ...
    var fetcher = axios ? constructFetcher$2(axios, {
      apiKey: apiKey
    }) : fetch ? constructFetcher$1(fetch, {
      apiKey: apiKey
    }) : null;
    tsEssentials.assert(fetcher, 'at least one fetcher is needed');
    ...
    var contractCaller = ethersDeps ? 'ethersV6ProviderOrSigner' in ethersDeps ? constructContractCaller$2(ethersDeps, account) : constructEthersV5ContractCaller(ethersDeps, account) : web3Provider ? constructContractCaller$1(web3Provider, account) : null;
    if (contractCaller) {
  ...
  _proto.setWeb3Provider = function setWeb3Provider(web3Provider, account) {
    var contractCaller = constructContractCaller$1(web3Provider, account);
  ...
  _proto.setEthersProvider = function setEthersProvider(ethersDeps, account) {
    ...
    if ('ethersV6ProviderOrSigner' in ethersDeps) {
      var contractCaller = constructContractCaller$2(ethersDeps, account);
      this.sdk = constructSwapSDK({
        fetcher: fetcher,
        contractCaller: contractCaller,
        apiURL: apiURL,
      ...
      var _contractCaller = constructEthersV5ContractCaller(ethersDeps, account);
      this.sdk = constructSwapSDK({
        fetcher: fetcher,
  ...
  function () {
    var _getTokens = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            tsEssentials.assert(this.sdk.getTokens, 'sdk must be initialized with a fetcher');
            _context2.prev = 1;
            _context2.next = 4;
  ...
  _proto.getAdapters = /*#__PURE__*/function () {
    var _getAdapters = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            tsEssentials.assert(this.sdk.getAdapters, 'sdk must be initialized with a fetcher');
            _context3.prev = 1;
            _context3.next = 4;
    ...
    var _getRateByRoute = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(route, amount, userAddress, side, options, srcDecimals, destDecimals) {
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            if (side === void 0) {
              side = core.SwapSide.SELL;
            }
            tsEssentials.assert(this.sdk.getRateByRoute, 'sdk must be initialized with a fetcher');
            if (!(route.length < 2)) {
              _context4.next = 4;
              break;
            }
      ...
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            ...
            tsEssentials.assert(this.sdk.getRate, 'sdk must be initialized with a fetcher');
            _context5.prev = 3;
            _context5.next = 6;
      ...
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          case 0:
            ...
            tsEssentials.assert(this.sdk.buildTx, 'sdk must be initialized with a fetcher');
            _context6.prev = 2;
            _context6.next = 5;
    ...
    var _getTokenTransferProxy = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee7(_provider) {
      return _regeneratorRuntime().wrap(function _callee7$(_context7) {
        while (1) switch (_context7.prev = _context7.next) {
          case 0:
            tsEssentials.assert(this.sdk.getSpender, 'sdk must be initialized with a fetcher');
            _context7.prev = 1;
            _context7.next = 4;
    ...
    var _getAllowances = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee8(userAddress, tokenAddresses) {
      return _regeneratorRuntime().wrap(function _callee8$(_context8) {
        while (1) switch (_context8.prev = _context8.next) {
          case 0:
            tsEssentials.assert(this.sdk.getAllowances, 'sdk must be initialized with a fetcher');
            _context8.prev = 1;
            _context8.next = 4;
    ...
    var _getAllowance = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee9(userAddress, tokenAddress) {
      return _regeneratorRuntime().wrap(function _callee9$(_context9) {
        while (1) switch (_context9.prev = _context9.next) {
          case 0:
            tsEssentials.assert(this.sdk.getAllowance, 'sdk must be initialized with a fetcher');
            _context9.prev = 1;
            _context9.next = 4;
  ...
  _proto.approveTokenBulk = /*#__PURE__*/function () {
    var _approveTokenBulk = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee10(amount, userAddress, tokenAddresses, /** @deprecated */
      ...
      return _regeneratorRuntime().wrap(function _callee10$(_context10) {
        while (1) switch (_context10.prev = _context10.next) {
          case 0:
            ...
            tsEssentials.assert(this.sdk.approveTokenBulk, 'sdk must be initialized with a provider');
            _context10.prev = 1;
            _context10.next = 4;
  ...
  _proto.approveToken = /*#__PURE__*/function () {
    var _approveToken = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee11(amount, userAddress, tokenAddress, /** @deprecated */
    _provider,
    // not used, can't detect if Ethers or Web3 provider without importing them
    sendOptions) {
      var txResponse;
      return _regeneratorRuntime().wrap(function _callee11$(_context11) {
        while (1) switch (_context11.prev = _context11.next) {
          case 0:
            // @TODO expand sendOptions
            tsEssentials.assert(this.sdk.approveToken, 'sdk must be initialized with a provider');
            _context11.prev = 1;
            _context11.next = 4;
            return this.sdk.approveToken(amount, tokenAddress, sendOptions);
          case 4:
    ...
    var _getBalance = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee13(userAddress, token) {
      return _regeneratorRuntime().wrap(function _callee13$(_context13) {
        while (1) switch (_context13.prev = _context13.next) {
          case 0:
            tsEssentials.assert(this.sdk.getBalance, 'sdk must be initialized with a fetcher');
            _context13.prev = 1;
            _context13.next = 4;
    ...
    var _getBalances = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee14(userAddress) {
      return _regeneratorRuntime().wrap(function _callee14$(_context14) {
        while (1) switch (_context14.prev = _context14.next) {
          case 0:
            tsEssentials.assert(this.sdk.getBalances, 'sdk must be initialized with a fetcher');
            _context14.prev = 1;
            _context14.next = 4;
